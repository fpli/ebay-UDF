...
public class SojParseRlogid extends UDF {
    ...
    public Text evaluate(String rlogId, String infoType) {
        ...
        if ("pool".equals(infoType)) {
            if (end == -1 || end == 0) {
                ...
                return new Text(poolmachine.substring(0, end));
            }
        }
