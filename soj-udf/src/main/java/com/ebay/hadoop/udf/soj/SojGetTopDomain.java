...
public class SojGetTopDomain extends UDF {
        ...
        switch (ch) {
            ...
            case 'b':
                if (gTLDlen == 3 && lowergTLDin.substring(1, 3).equals("iz")) {
                    isgTLD = 1;
                } else if (gTLDlen == 2 && (lowergTLDin.substring(1, 2).equals("c") || lowergTLDin.substring(1, 2).equals("d"))) {
                    isgTLD = 1;
                }
                break;
            case 'i':
