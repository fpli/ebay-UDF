...
public class SojFunctionOneDecode extends GenericUDF {
    ...
    public Object evaluate(DeferredObject[] args) throws HiveException {
        ...
        return SojUtils.parsePayload(payload, keywords, 1);
    }

    @Override
    public String getDisplayString(String[] args) {
        return "SojFuSojFunctionOneDecodenction to parse key-value pairs from behavior URL";
    }
    ...
    public ObjectInspector initialize(ObjectInspector[] args) throws UDFArgumentException {
        if (args.length != 2) {
            throw new UDFArgumentLengthException(
                    "SojFunction takes two Strings as input, first is url, second is keys seperated by comma");
        }
