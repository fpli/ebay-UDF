...
public class SojGetBase64EncodedBitsSets {
            ...
            if(return_val == 1){
                ...
                if(result_len == 0){
                    ...
                    if(String.valueOf(bit_pos).length() >= freespace){
                        ...
                        result = result + String.valueOf(bit_pos);
                    }
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("value = " + getBase64EncodedBitsSetValue("EGAEAAAAQAAEAwEACACUAAAAAAAAAIAAAAIAAQIAAAAAAAAAgAAAABIAEAgESQAAAQAADAAAoAYABAAIAAAAAgAAgKBAAAAAAAAAAAQAAEWgQJBCocAAEENCEAIAmAgKBAQEACgCBCAwkAIBAACARIIAgAAgQAAAAIAEAAAABBA"));
    }
