...
public class RiskNormalizeCountryTest {

  RiskNormalizeCountry riskNormalizeCountry = new RiskNormalizeCountry();

  public void assertCntry(String rawCntry, String fullCntry) {
    assertEquals(fullCntry, riskNormalizeCountry.evaluate(rawCntry));
  }

  public void assertCntry(int rawCntry, String fullCntry) {
    assertEquals(fullCntry, riskNormalizeCountry.evaluate(rawCntry));
  }
